...
public class OpenSplitBlocks extends BlockTransferMessage {
  public final String appId;
  public final String execId;
  public final String[] blockIds;

  public OpenSplitBlocks(String appId, String execId, String[] blockIds) {
    this.appId = appId;
    this.execId = execId;
  ...
  public boolean equals(Object other) {
    if (other != null && other instanceof OpenSplitBlocks) {
      OpenSplitBlocks o = (OpenSplitBlocks) other;
  ...
  public static OpenSplitBlocks decode(ByteBuf buf) {
    String appId = Encoders.Strings.decode(buf);
    String execId = Encoders.Strings.decode(buf);
    String[] blockIds = Encoders.StringArrays.decode(buf);
    return new OpenSplitBlocks(appId, execId, blockIds);
  }
}
